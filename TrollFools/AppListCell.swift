        ...
        // --- 插入开始 ---
                    Button {
                        ...
                        if app.isPinnedToHome {
                            Label(NSLocalizedString("Remove from Shortcuts", comment: "从快捷菜单移除"), systemImage: "minus.circle")
                        } else {
                            Label(NSLocalizedString("Add to Shortcuts", comment: "添加到快捷菜单"), systemImage: "plus.circle")
                        }
                    }
                    // --- 插入结束 ---
